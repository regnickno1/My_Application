        ...
        OutlinedTextField(
            ...
            trailingIcon = {
                IconButton(onClick = {
                    ...
                    Icon(
                        imageVector = if (passwordVisibility.value) Icons.Default.Done else Icons.Default.Create,
        ...
        OutlinedTextField(
            ...
            trailingIcon = {
                IconButton(onClick = {
                    ...
                    Icon(
                        imageVector = if (cPasswordVisibility.value) Icons.Default.Done else Icons.Default.Create,
                        contentDescription = "visibility",
                        tint = Color.Red
                    )
                }
